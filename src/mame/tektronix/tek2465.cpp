...
INPUT_PORTS_START(tek2465)
	...
	PORT_START("ROW1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_NAME("CH4_VOLTS_DIV")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_NAME("CH3_VOLTS_DIV")
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED)
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_KEYPAD ) PORT_NAME("A_B_TRIG") PORT_CODE(KEYCODE_HOME)
